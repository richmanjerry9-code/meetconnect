...
export default function AdminPanel() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const transactionsSnapshot = await getDocs(transactions);
  ...
  // GROUP CHAT: Change Profile Picture (Only Admin)
  ...
  return (
    ...
    >
      ...
      {/* Users Section with Kick Button */}
      <div style={{ background: 'white', padding: '20px', borderRadius: '8px', marginBottom: '30px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
              ...
              {filteredUsers.map((u) => {
                ...
                return (
                  <tr key={u.id} style={{ borderBottom: '1px solid #ddd' }}>
                    ...
                    <td style={{ padding: '12px', fontWeight: 'bold', color: isBanned ? '#f44336' : '#4caf50' }}>
                    ...
                    <td style={{ padding: '12px' }}>
                      ...
                      <button
                        onClick={() => kickUser(u.id, u.username)}
                        style={{
                          padding: '8px 12px',
                          background: isBanned ? '#4caf50' : '#ff1744',
                          color: 'white',
                          border: 'none',
                          borderRadius: '4px',
                          marginRight: '10px',
