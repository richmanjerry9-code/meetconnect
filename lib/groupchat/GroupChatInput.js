...
export default function GroupChatInput({ onSend, onTyping }) {
  ...
  const [viewOnce, setViewOnce] = useState(false); // View once option
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSending(true);
      await onSend(text.trim(), imageFile, audioBlob, viewOnce);
      setText("");
      setImageFile(null);
      setAudioBlob(null);
      setViewOnce(false);
