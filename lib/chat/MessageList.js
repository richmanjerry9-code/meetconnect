// MessageList component (with date label fixed exactly as requested, sorting added, and memoization for performance)
"use client";
...
export default function MessageList({
  ...
  // 1. FILTER + SORT: Remove deleted messages and sort by timestamp ascending
  ...
  const groupedMessages = useMemo(() => {
    return visibleMessages.reduce((groups, msg) => {
