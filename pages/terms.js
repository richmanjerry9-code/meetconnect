export default function Terms() {
  return (
    <div className="p-6 max-w-3xl mx-auto text-gray-800">
      ...
      <p>
        MeetConnect is a social networking platform for adults (18+) to connect for friendship, dating, or networking. By using this platform, you agree to the following terms:
      </p>
      ...
      <p className="mt-4">
        For support or questions regarding these Terms, contact us at <a href="mailto:meetconnect19@gmail.com" className="text-blue-600 underline">meetconnect19@gmail.com</a>.
      </p>
    </div>
  );
}
