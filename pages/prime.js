...
export default function Prime({ initialProfiles = [] }) {
 ...
 .includes(searchTerm)
 : true;
 const membershipMatch = p.membership === 'Prime' || p.membership === 'VIP' || p.membership === 'VVIP';
 ...
 <Head>
 <title>Meet Connect Ladies - Prime</title>
 <meta
 name="description"
 content="Discover Prime, VIP, and VVIP ladies across Kenya on Meet Connect Ladies."
 />
 <meta name="keywords" content="dating Kenya, ladies Nairobi, meet connect, gentlemen profiles" />
 <meta property="og:title" content="Meet Connect Ladies - Prime" />
 <meta property="og:description" content="Connect with Prime, VIP, and VVIP ladies across Kenya." />
 <meta property="og:type" content="website" />
 <meta name="viewport" content="width=device-width, initial-scale=1" />
 <meta name="robots" content="index, follow" />
 <link rel="canonical" href="https://yourdomain.com/prime" />
 </Head>
...
const ProfileCard = memo(({ p, router }) => {
 ...
 e.target.src = 'data:image/svg+xml;base64, NSIgWT0iMTAwIiBmb250LWZhbWlseT0iQXJpYWwiIGZvbnQtc2l6ZT0iMTIiIGZpbGw9IiM5OTkiIHRleHQtYW5jaG9yPSJtaWRkbGUiPk1pc3NpbmcgUGljPC90ZXh0Pjwvc3ZnPg==';
 };
