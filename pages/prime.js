    ...
    let filtered = allProfiles.filter((p) => {
      ...
      const searchMatch = debouncedSearchLocation
        ? [p.county || '', p.ward || '', p.area || '', ...(p.nearby || [])]
          ...
          .includes(searchTerm)
        : true;
      const membershipMatch = p.membership === 'Prime';
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Prime ladies across Kenya on Meet Connect Ladies."
        />
        ...
        <meta property="og:description" content="Connect with Prime ladies across Kenya." />
