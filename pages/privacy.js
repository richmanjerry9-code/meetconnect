export default function Privacy() {
  return (
    <div className="p-6 max-w-3xl mx-auto text-gray-800">
      ...
      <p className="mt-4">
        For support or questions regarding privacy, contact us at <a href="mailto:meetconnect19@gmail.com" className="text-blue-600 underline">meetconnect19@gmail.com</a>.
      </p>
    </div>
  );
}
